...
@section('content')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h2 class="modal-title" id="sign_up_popupLabel2">Add panel</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="twm-tabs-style-2">
                            <form id="f" action="{{ 'save-panels' }}" method="POST"
    ...
    @foreach ($data as $panels)
        <div style="width:100%;" class="modal fade twm-sign-up" id="editModal{{ $panels->id }}" tabindex="-1"
            role="dialog" aria-labelledby="exampleModalLabel{{ $panels->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel{{ $panels->id }}">Edit Event</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Form for editing blog -->
                        <form id="editForm{{ $panels->id }}"
                            action="{{ route('update-panels', ['id' => $panels->id]) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" id="myTab2Content">
                                <!--Login Candidate Content-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label for="description"><b>Description<span class="text-danger">
                                                            *</span></b></label>
                                                <textarea type="text" class="form-control" name="description" id="edescription" rows="5">{{ $panels->description }}</textarea>
                                            </div>
                                        </div>
