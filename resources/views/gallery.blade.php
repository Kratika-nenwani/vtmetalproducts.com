...
@section('content')
    ...
    <h1 style="text-align: center;color: #FE5D14;margin-top:50px;font-size:50px;font-weight:800;"><b>Products</b></h1>
    <br> <br>

    <section class="contact-area pt-30 pb-120">
        <div class="container">
            <div class="headings">
                <button class="btn-heading" id="btn-images">Images</button>
                <button class="btn-heading" id="btn-videos">Videos</button>
            </div>
            <br><br>
            <div class="technology row py-3" style="text-align: center" id="content-images">
                <div class="row" style="margin-bottom: 30px;">
                    
                    @foreach($data as $images)
                    <div class="col-lg-4" style="margin-bottom: 20px;">
                        <div class="card">
                            <a href="{{ route('gallery_images', ['id'=> $images->id ]) }}">
                            <img src="{{asset ('Images/' . $images->image)}}" alt="Almirah"
                                class="card-img-top custom-img">
                            <div class="card-body" style="padding:1rem 1rem;">
                                <h5 class="card-title">{!!$images->description!!}</h5>
                            </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="technology row py-3" style="text-align: center; display: none" id="content-videos">
                <!-- Video Content -->
                    ...
                    <div class="row">
                        @foreach($videos as $video)
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{ Route('gallery_videos', ['id' => $video->id]) }}"><img src="{{ asset('Images/' . $video->image) }}" alt="image" class="custom-img"></a>
                                        <a href="{{ Route('gallery_videos', ['id' => $video->id]) }}"><h3>{{ $video->name }}</h3></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
